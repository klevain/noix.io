...
(function(global, factory) {
    ...
    var SLIDES_ARROW_INACTIVE =   'fp-inactive';
    var SLIDES_ARROW_INACTIVE_SEL = '.' + SLIDES_ARROW;
        ...
        */
        function createSlideArrows(section){
            ...
            if(!options.loopHorizontal){
                ...
                section.find(SLIDES_ARROW_PREV_SEL).addClass(SLIDES_ARROW_INACTIVE);
            }
        }
        ...
        */
        function landscapeScroll(slides, destiny){
            ...
            if(!options.loopHorizontal && options.controlArrows){
                ...
                section.find(SLIDES_ARROW_PREV_SEL).toggleClass(SLIDES_ARROW_INACTIVE, slideIndex!==0);

                //hidding it for the last slide, showing for the rest
                section.find(SLIDES_ARROW_NEXT_SEL).toggle(SLIDES_ARROW_INACTIVE,!destiny.is(':last-child'));
            }
